...
?>
<style>
	:root{--black:#1b1e23;--dark:#282c34;--lightgrey:#abb2bf;--grey:#818896;--darkgrey:#5c6370;--bluegreen:#56b6c2;--blue:#61aeee;--pink:#c678dd;--salomon:#e06c75;--green:#98c379;--red:#be5046;--orange:#d19a66;--yellow:#e6c07b}body{margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:var(--lightgrey);background-color:var(--dark);overflow:auto}html{scrollbar-face-color:var(--darkgrey);scrollbar-base-color:var(--darkgrey);scrollbar-3dlight-color:var(--darkgrey);scrollbar-highlight-color:var(--darkgrey);scrollbar-track-color:var(--blue);scrollbar-arrow-color:var(--blue);scrollbar-shadow-color:var(--darkgrey)}.left_td{width:100px}a{color:var(--blue);text-decoration:none;cursor:pointer}a:hover{color:var(--red)}hr{height:1px;border:0;color:var(--lightgrey);background-color:var(--lightgrey);width:100%}h1{margin:0;padding:5px;font-size:24px;background-color:var(--dark);text-align:center;color:var(--salomon);border-top-left-radius:5px;border-top-right-radius:5px;-moz-border-radius-topleft:5px;-moz-border-radius-topright:5px}#headerlinks{text-align:center;margin-bottom:10px;padding:5px 15px;border-color:var(--blue);border-width:1px;border-style:solid;border-left-style:none;border-right-style:none;font-size:12px;background-color:var(--dark);font-weight:700}h1 #version{color:var(--salomon);font-size:16px}h1 #logo{color:var(--salomon)}h2{margin:0;padding:0;font-size:14px;margin-bottom:20px}.CodeMirror,input,select,textarea{font-family:Arial,Helvetica,sans-serif;background-color:var(--dark);color:var(--lightgrey);border-color:var(--blue);border-style:solid;border-width:1px;margin:5px;border-radius:5px;-moz-border-radius:5px;padding:3px}input.btn,input[type=file]{background-color:var(--dark);color:var(--lightgrey);cursor:pointer;padding:.2em .4em}input.btn:hover{background-color:var(--blue);color:var(--dark)}select#fieldcontainer{height:310px}fieldset label{min-width:200px;display:block;float:left}fieldset{padding:15px;border-color:var(--blue);border-width:1px;border-style:solid;border-radius:5px;-moz-border-radius:5px;background-color:var(--dark)}#container{padding:10px}#leftNav{min-width:250px;padding:0;border-color:var(--blue);border-width:1px;border-style:solid;background-color:var(--dark);padding-bottom:15px;border-radius:5px;-moz-border-radius:5px}.databaseList select{max-width:200px}.viewTable tr td{padding:1px 4px;white-space: nowrap;max-width: 400px;overflow: hidden;}#loginBox{width:500px;margin-left:auto;margin-right:auto;margin-top:50px;border-color:var(--blue);border-width:1px;border-style:solid;background-color:var(--dark);border-radius:5px;-moz-border-radius:5px}#main{border-color:var(--blue);border-width:1px;border-style:solid;padding:15px;background-color:var(--dark);border-bottom-left-radius:5px;border-bottom-right-radius:5px;border-top-right-radius:5px;-moz-border-radius-bottomleft:5px;-moz-border-radius-bottomright:5px;-moz-border-radius-topright:5px}.td1{background-color:var(--dark);color:var(--yellow);text-align:right;font-size:12px;padding-left:10px;padding-right:10px}.td2{background-color:var(--dark);color:var(--orange);text-align:right;font-size:12px;padding-left:10px;padding-right:10px}.viewTable tr:hover td:not(.tdheader){background:var(--darkgrey);opacity:.5}.tdheader{position:sticky;top:0;background:var(--dark);font-weight:700;font-size:12px;height:30px;border-bottom:1px solid var(--darkgrey)}.tdheader a{padding-right:.8em}.confirm{border-color:var(--orange);border-width:1px;border-style:solid;border-radius:5px;padding:15px;color:var(--red);background-color:var(--dark)}.tab{display:block;padding:5px;padding-right:8px;padding-left:8px;border-color:var(--blue);border-width:1px;border-style:solid;margin-right:5px;float:left;border-bottom-style:none;position:relative;top:1px;padding-bottom:4px;background-color:var(--dark);border-top-left-radius:5px;border-top-right-radius:5px;-moz-border-radius-topleft:5px;-moz-border-radius-topright:5px}.tab_pressed{display:block;padding:5px;padding-right:8px;padding-left:8px;border-color:var(--salomon);color:var(--salomon);border-width:1px;border-style:solid;margin-right:5px;float:left;border-bottom-style:none;position:relative;top:1px;background-color:var(--dark);cursor:default;border-top-left-radius:5px;border-top-right-radius:5px;-moz-border-radius-topleft:5px;-moz-border-radius-topright:5px}.helpq{font-size:11px;font-weight:400}#help_container{padding:0;font-size:12px;margin-left:auto;margin-right:auto;background-color:var(--dark);color:var(--lightgrey)}.help_outer{background-color:var(--dark);padding:0;height:300px;position:relative}.help_list{padding:10px;height:auto}.headd{font-size:14px;font-weight:700;display:block;padding:10px;background-color:var(--dark);border-color:var(--blue);border-width:1px;border-style:solid;border-left-style:none;border-right-style:none}.help_inner{padding:10px}.help_top{display:block;position:absolute;right:10px;bottom:10px}.delete,.delete_db,.drop,.empty,.warning{color:var(--red)}.sidebar_table{font-size:11px}.active_db,.active_table{text-decoration:underline}.null{color:#888}.found{background:var(--yellow);text-decoration:none}.edit{font-size:0px}.edit:before{font-size:11px;content:"\1F589";padding-right:5px}.delete{font-size:0px}.delete:before{font-size:20px;content:"\2A2F"}input[type=checkbox]{filter:invert(20%) hue-rotate(300deg) brightness(.7)}.right_td>a:not(.tab_pressed){color:var(--orange);font-size:1.1em}.right_td>a:not(.tab){color:var(--orange);font-size:1.1em}.CodeMirror{font-family:monospace;height:300px;color:var(--lightgrey)!important;background:var(--dark)!important}.CodeMirror-gutters{border-right:1px solid var(--darkgrey)!important;background-color:var(--dark)!important;white-space:nowrap}.cm-s-default .cm-keyword{color:var(--salomon)!important}.cm-s-default .cm-atom{color:var(--red)!important}.cm-s-default .cm-number{color:var(--pink)!important}.cm-s-default .cm-def{color:#00f!important}.cm-s-default .cm-variable-2{color:var(--blue)!important}.cm-s-default .cm-variable-3{color:var(--green)!important}.cm-s-default .cm-comment{color:var(--darkgrey)!important}.cm-s-default .cm-string{color:var(--yellow)!important}.cm-s-default .cm-string-2{color:var(--orange)!important}.cm-s-default .cm-meta{color:var(--darkgrey)!important}.cm-s-default .cm-qualifier{color:var(--darkgrey)!important}.cm-s-default .cm-builtin{color:var(--blue)!important}.cm-s-default .cm-bracket{color:var(--yellow)!important}.cm-s-default .cm-tag{color:var(--green)!important}.cm-s-default .cm-attribute{color:var(--blue)!important}.cm-s-default .cm-hr{color:var(--grey)!important}.cm-s-default .cm-link{color:var(--blue)!important}.cm-s-default .cm-error{color:var(--red)!important}.cm-invalidchar{color:var(--red)!important}
</style>
<?php
	...
	//- Table actions
		...
		case "table_create":
			...
			else
			{
				...
				echo "<table border='0' cellpadding='2' cellspacing='0' class='viewTable'>";
				echo "<tr>";
